        ...
        <ul id="slides">
          <li class="slide">
            <div class="slide-partial slide-left">
              <img src="contenu_protege/assets/images/cinema_left.png" />
            </div>
            <div class="slide-partial slide-right">
              <img src="contenu_protege/assets/images/cinema_right.png" />
            </div>
            <h2 class="title">
          ...
          <li class="slide">
            <div class="slide-partial slide-left">
              <img src="contenu_protege/assets/images/titanic_left.png" />
            </div>
            <div class="slide-partial slide-right">
              <img src="contenu_protege/assets/images/titanic_right.png" />
            </div>
            <h2 class="title">
              <span class="title-text"
          ...
          <li class="slide">
            <div class="slide-partial slide-left">
              <img src="contenu_protege/assets/images/clint_eastwood_left.png" />
            </div>
            <div class="slide-partial slide-right">
              <img src="contenu_protege/assets/images/clint_eastwood_right.png" />
            </div>
            <h2 class="title">
              <span class="title-text"
          ...
          <li class="slide">
            <div class="slide-partial slide-left">
              <img src="contenu_protege/assets/images/la_cite_de_la_peur_left.png" />
            </div>
            <div class="slide-partial slide-right">
              <img src="contenu_protege/assets/images/la_cite_de_la_peur_right.png" />
            </div>
            <h2 class="title">
              <span class="title-text"
